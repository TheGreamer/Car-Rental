        ...
        where TService : IService<TEntity>
    {
        ...
        public virtual ActionResult Edit(TEntity entity, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                ...
                return Redirect($"~/Admin/{typeof(TEntity).Name}s/Edit/{entity.Id}");
            }
        ...
        public virtual ActionResult DeleteConfirmed(int id)
        {
            ...
            return Content(Utility.RedirectWithMessage($"{Utility.Translate(typeof(TEntity).Name)} silindi. Listeye yönlendiriliyorsunuz.", $"Admin/{typeof(TEntity).Name}s", duration: 1.0));
        }
        ...
        {
            if (id == null)
                return Content(Utility.RedirectWithMessage("Hatalı işlem gerçekleşti. Listeye yönlendiriliyorsunuz.", $"Admin/{typeof(TEntity).Name}s"));
