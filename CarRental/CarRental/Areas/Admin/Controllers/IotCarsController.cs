    ...
    public class IotCarsController : Controller
    {
        ...
        public ActionResult Edit(IotCar iotCar, int Id, int DeviceId)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return Redirect($"~/Admin/IotCars/Edit/{iotCarToUpdate.Id}");
            }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            return Content(Utility.RedirectWithMessage($"IOT araç silindi. Listeye yönlendiriliyorsunuz.", $"Admin/IotCars", duration: 1.0));
        }
        ...
        {
            if (id == null)
                return Content(Utility.RedirectWithMessage("Hatalı işlem gerçekleşti. Listeye yönlendiriliyorsunuz.", $"Admin/IotCars"));
